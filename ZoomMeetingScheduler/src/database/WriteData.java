        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "If you want to update any information, delete the 'DELETE_ME_IF_NOT_FUNCTIONED_CORRECTLY.db' file and restart the application.\n"
